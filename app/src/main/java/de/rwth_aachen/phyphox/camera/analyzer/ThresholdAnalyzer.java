...
public class ThresholdAnalyzer extends AnalyzingModule {
    ...
    void drawThresholdDownsampling(int step, float[] camMatrix) {
        ...
        GLES20.glUniform2f(thresholdDownsamplingResSourceHandle, step == 0 ? analyzerConfig.width() : wDownsampleStep[step-1], step == 0 ? analyzerConfig.height() : hDownsampleStep[step-1]);
